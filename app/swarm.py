...
livepeer_swarm = Swarm(
    ...
    1. Coordinate with these agents in order:
       ...
       e. Scene Image Generator Agent: generates images from the prompts, max 3 files at a time
       f. Scene Image to Video Generator Agent: creates videos from the images, max 3 files at a time
