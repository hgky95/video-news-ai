...
def save_bytes_to_file(content: bytes, file_name: str, file_path: str) -> None:
    """
    Saves the given binary content (like audio) to a file at the specified path with the specified file name.

    :param content: The binary content to be written to the file.
    :param file_name: The name of the file to save the content in.
    :param file_path: The path where the file should be saved.
    """
